...
--
-- Host: localhost
-- Generation Time: Nov 28, 2022 at 03:09 PM
...
(8, '12', '78', 'NA', 'No', 'no circum', 'Collgege', 'Science', 'vishwakaram', 4, NULL, NULL);
...
INSERT INTO `event_handle` (`id`, `evName`, `evDetails`, `startDate`, `endDate`, `participant`, `notInterested`, `anoId`, `future1`, `future2`, `future3`) VALUES
(1, 'Summer Camp', 'We have to decided to held a camp in this summer vacation . I know you have waited for this long time so this is it. We are finally going to camp. In this camp we are gonna do all the activities like, tracking, cycling, camping, etc.', '2022-11-26', '2022-11-27', NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Winter Camp', 'Organize to train all new cadets', '2022-12-05', '2022-12-10', '4', NULL, 1, NULL, NULL, NULL);
...
(5, 'No', '1 GUJ CTC NCC AHMEDABAD', 'No', '200170116021', 'Yes', 'no need to\r\n                                ', 'mayank', '9313268918', 'mayank', 4, NULL, NULL);
...
(18, 'mayank', 'mayank', 'mayank', '2022-11-18', 'indian', 'mayhank', 'amnksh', 'mayahnk', 'mayank', 'mayank', 'jmayahnk', 'ukai ukai ', '9313268612', 'mrmayank6877@gmail.com', 'Male', 'A+', 'ahmedabad', 'ahmedabad', 4, NULL, NULL);
...
INSERT INTO `student_credentials` (`id`, `email`, `password`, `anoID`, `regNo`, `future1`, `future2`, `active_status`) VALUES
(4, 'mrmayank6877@gmail.com', '25d55ad283aa400af464c76d713c07ad', 1, 'GJ/20/SDA/110132', NULL, NULL, 1),
(5, 'sannin6877@gmail.com', '3660fe19cb5a26939d9cbda731f5bc96', 1, NULL, NULL, NULL, 1),
(6, 'govind@duck.com', '644b9b9793690178346bbc3cb3efa544', 1, NULL, NULL, NULL, 1);

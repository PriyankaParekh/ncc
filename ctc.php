        ...
        <div id="form">
            <div class="container">
                ...
                <div class="grid-container parts2">
                    ...
                    <div class="grid-item">
                        <u style="font-weight: bold; font-size:large">1 Gujarat CTC NCC, Ahmedabad_______________________________(Tele: 079-26300904)</u>
                    </div>
                </div>
                <br>
                <center>
                ...
                <div class="grid-container image">
                    ...
                    <div class="grid-item" style="text-align: center;"><img src="images/logo.png" alt="" style="height: 3rem; width: 3rem;"><br>Signature of Medical Officer/Doctor(MBBS)<br>(Name in Capital letter Regtl No & seal)</div>
                    <br>
